...
def generate_launch_description():
    ...
    dec_node = Node(package='decision', executable='ms2_go_to_obj_planning_node')
    ld = LaunchDescription([chassis_launch, mapping_launch, tar_ctrl_node, dec_node, sensor_launch, path_planner_node])
